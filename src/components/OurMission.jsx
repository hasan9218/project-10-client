  ...
  <div className="max-w-5xl mx-auto text-center px-4">
    ...
    <div className="grid md:grid-cols-3 gap-6">
      <div className="p-6 bg-green-50 rounded-2xl shadow">
        <img src={img1} alt="" />
        <h3 className="text-2xl font-bold text-green-700 mb-2">Sustainability</h3>
        <p className="text-gray-600">Reducing food waste to protect our planet’s resources.</p>
      </div>
      <div className="p-6 bg-green-50 rounded-2xl shadow">
        <img src={img2} alt="" />
        <h3 className="text-2xl font-bold text-green-700 mb-2">Community</h3>
        <p className="text-gray-600">Bringing people together through sharing and care.</p>
      </div>
      <div className="p-6 bg-green-50 rounded-2xl shadow">
        <img src={img3} alt="" />
        <h3 className="text-2xl font-bold text-green-700 mb-2">Compassion</h3>
