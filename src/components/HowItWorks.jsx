    ...
    <div>
      <section className="py-20 bg-[#F0FDF4]">
        <div className="max-w-7xl mx-auto text-center px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-10 text-[#0D542B]">
            How It Works
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 bg-white rounded-2xl shadow">
              ...
              <img src={postimg} alt="" />
              <h3 className="text-2xl font-semibold my-5 text-green-700">Post Food</h3>
            ...
            <div className="p-6 bg-white rounded-2xl shadow">
              <img src={findimg} alt="" />
              <h3 className="text-2xl font-semibold my-5 text-green-700">Find Food</h3>
              <p className="text-gray-600">
            ...
            <div className="p-6 bg-white rounded-2xl shadow">
              ...
              <h3 className="text-2xl font-semibold my-5 text-green-700">Collect Food</h3>
              <p className="text-gray-600">
